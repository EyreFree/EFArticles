...
![Kingfisher 的 Wiki 页面](/images/2017/GitHub-Wiki-Introduction/1.png)

## 二. Wiki 的开启和关闭

GitHub 项目的 Wikis 功能默认是开启的，如果你没有找到 Wiki 选项卡，可能是因为该项目关闭了 Wikis 选项，在项目 Setting 中将其选中即可，如图所示：

![Wikis 开关](/images/2017/GitHub-Wiki-Introduction/2.png)
...
![新建页面完成](/images/2017/GitHub-Wiki-Introduction/6.png)
...
![image.png](/images/2017/GitHub-Wiki-Introduction/7.png)
...
![Add a custom footer](/images/2017/GitHub-Wiki-Introduction/8.png)
...
![Kingfisher 页脚效果](/images/2017/GitHub-Wiki-Introduction/9.png)

当然也可以放一些奇怪的东西，比如，这样的：

![+1s](/images/2017/GitHub-Wiki-Introduction/10.png)
...
![Add a custom sidebar](/images/2017/GitHub-Wiki-Introduction/11.png)
...
![Kingfisher 的侧边栏](/images/2017/GitHub-Wiki-Introduction/12.png)

这里的话可以自己适当摸索一下，调整标题层级等样式，以获得一个自己比较满意的展示效果。同样的，点击侧边栏右上角的编辑按钮可以对快速侧边栏进行在线编辑。

![侧边栏编辑按钮](/images/2017/GitHub-Wiki-Introduction/13.png)

## 六. 查看编辑历史

进入某个页面的编辑页面，点击右上角的 `Page History` 按钮，可以查看该页面的编辑历史，如下图所示：

![Page History 按钮](/images/2017/GitHub-Wiki-Introduction/14.png)

![编辑历史页面](/images/2017/GitHub-Wiki-Introduction/15.png)
...
![Restrict editing to collaborators only](/images/2017/GitHub-Wiki-Introduction/16.png)
...
![Wiki 仓库地址](/images/2017/GitHub-Wiki-Introduction/17.png)

Kingfisher 的 Wiki 仓库结构如下：

![Kingfisher Wiki 结构](/images/2017/GitHub-Wiki-Introduction/18.png)
...
![Gollum 预览](/images/2017/GitHub-Wiki-Introduction/19.png)
...
> https://www.eyrefree.org/2017/GitHub-Wiki-Introduction   
