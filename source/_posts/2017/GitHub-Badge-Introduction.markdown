...
![请随意](/images/2017/GitHub-Badge-Introduction/3.png)
...
![](/images/2017/GitHub-Badge-Introduction/4.png)
...
![Paste_Image.png](/images/2017/GitHub-Badge-Introduction/5.png)

更多信息可参考 [官方文档](https://docs.codecov.io/docs) 和 [示例](https://github.com/codecov)。

然后，我们就可以在 Setting 中的 Badge 一栏找到添加图标的代码啦：

![Paste_Image.png](/images/2017/GitHub-Badge-Introduction/6.png)
...
![Swift](/images/2017/GitHub-Badge-Introduction/7.png)
...
![Webhooks](/images/2017/GitHub-Badge-Introduction/8.png)

照着引导巴拉巴拉一顿操作之后就可以获取图标啦，在项目的 Setting 中可以获取徽标代码，自己复制出来就可以。

![Setting](/images/2017/GitHub-Badge-Introduction/9.png)
...
> https://www.eyrefree.org/2017/GitHub-Badge-Introduction   
